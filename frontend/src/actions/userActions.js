...
export const register = (name , email, password, isSeller) => async(dispatch)=>{
    ...
    try{
        const {data} = await axios.post('/api/users/register', {name, email, password, isSeller});
