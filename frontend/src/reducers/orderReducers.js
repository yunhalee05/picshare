...
export const orderMineListReducer = (state={orders:[]}, action)=>{
    switch(action.type){
        ...
        case ORDER_MINE_LIST_SUCCESS:
            return {loading:false, orders:action.payload.orders, pages:action.payload.pages, count:action.payload.count}
